...
// biome-ignore lint/suspicious/noExplicitAny: JSDOM window needs to be typed as any
...
// biome-ignore lint/suspicious/noExplicitAny: Global interface extension
...
mock.module("next/image", () => ({
	...
	default: (props: any) => {
		...
		// biome-ignore lint/performance/noImgElement: Mocking next/image with standard img
...
mock.module("motion/react", () => {
	const mockComponent = (tag: string) => {
		// biome-ignore lint/suspicious/noExplicitAny: mock wrapper
