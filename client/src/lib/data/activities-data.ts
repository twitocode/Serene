...
export const WELLNESS_ACTIVITIES: Activity[] = [
	{
		...
		description:
			"Take a mindful pause with box breathing: inhale for 4, hold for 4, exhale for 4, hold for 4.",
	...
	},
	{
		...
		description:
			"Lie down and mentally scan your body from head to toe, releasing tension as you go.",
		category: ActivityCategory.Mindfulness,
		duration: "15 min",
	...
	},
	{
		...
		description:
			"Brew your favorite tea and savor each sip, focusing on the warmth, aroma, and taste.",
		category: ActivityCategory.Mindfulness,
		duration: "10 min",
		icon: "coffee",
	},
	...
	// Movement
	{
		...
		description:
			"Do a full-body stretch routine to release tension and improve flexibility.",
	...
	},
	{
		...
		title: "Write a Poem",
		description:
			"Express your feelings through poetry. It doesn't have to rhyme!",
		category: ActivityCategory.Creative,
		duration: "15 min",
		icon: "pen-line",
	},
	{
		...
		description:
			"Cut out images from magazines or print them online to create a vision board.",
		category: ActivityCategory.Creative,
		duration: "30 min",
		icon: "scissors",
	},
	{
		...
		description:
			"Take your phone or camera and capture beautiful moments around you.",
		category: ActivityCategory.Creative,
		duration: "20 min",
		icon: "camera",
	},
	...
	// Social
	{
		...
		title: "Call a Friend",
		description:
			"Reach out to someone you haven't talked to in a while and catch up.",
	...
	},
	{
		...
		description:
			"Open up to someone you trust about how you've been feeling lately.",
		category: ActivityCategory.Social,
		duration: "20 min",
		icon: "message-circle",
	},
	{
		...
		description:
			"Participate in a local club, class, or online community that interests you.",
		category: ActivityCategory.Social,
		duration: "60 min",
		icon: "users",
	},
	...
	// Self-Care
	{
		...
		description:
			"Draw a warm bath, add some salts or bubbles, and let yourself unwind.",
	...
	},
	{
		...
		description:
			"Curl up with a good book or magazine and escape into another world.",
		category: ActivityCategory.SelfCare,
		duration: "30 min",
		icon: "book-open",
	},
	...
	// Learning
	{
		...
		description:
			"Look up a word you don't know and try to use it in a sentence today.",
	...
	},
	{
		...
		description:
			"Find a podcast episode about mental health, wellness, or personal growth.",
		category: ActivityCategory.Learning,
		duration: "30 min",
		icon: "headphones",
	},
