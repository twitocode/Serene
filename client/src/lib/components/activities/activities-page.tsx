...
import { ActivityResponse } from "@/lib/types/api-types";
import { CalendarPlus, Check, Heart, Sparkles, Trash2 } from "lucide-react";
        ...
        <DialogContent className="sm:max-w-md">
          <AnimatePresence mode="wait">
            {dialogStep === "mood" ? (
              ...
              >
                <DialogHeader>
                  <DialogTitle className="font-serif">How did it go?</DialogTitle>
                  <DialogDescription>
                ...
                <div className="space-y-4 py-2">
                  <div className="space-y-2">
                    <p className="text-sm font-medium text-foreground">Mood before</p>
                    <MoodScale value={moodBefore} onChange={setMoodBefore} />
                  </div>
                  <div className="space-y-2">
                    <p className="text-sm font-medium text-foreground">Mood after</p>
              ...
              >
                <DialogHeader>
                  <div className="flex items-center gap-2">
                    ...
                    <DialogTitle className="font-serif">Savor this moment</DialogTitle>
                  </div>
