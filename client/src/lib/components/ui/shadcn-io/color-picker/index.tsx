...
export const ColorPicker = ({
	...
	}, [value, defaultValue, saturation, lightness, hue, alpha]);
	...
	useEffect(() => {
		...
		if (onChangeRef.current) {
			...
			const hex = color.hex();
			// Only call onChange if it's different from the current value prop
			if (hex !== value) {
