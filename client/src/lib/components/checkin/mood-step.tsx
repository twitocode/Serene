    ...
    >
        ...
        <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:gap-8">
          ...
          <div className="min-w-0 flex-1 space-y-2 text-center sm:text-left">
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              Choose a single word that fits you best. Look through vibe, energy,
              mental, or status, then tap one option. You can change your mind
              before continuing.
            </p>
          </div>
        </div>
      ...
      <div className="flex flex-col gap-4 md:gap-5">
        ...
        <MoodPicker
          ...
          Icon={CloudLightning}
        />
        <MoodPicker scrollToBottom={scrollToBottom} type="mental" Icon={Brain} />
        <MoodPicker
          scrollToBottom={scrollToBottom}
          type="status"
          Icon={Shield}
