ALTER TABLE "safety-plan" RENAME TO "safety_plan";--> statement-breakpoint
...
ALTER TABLE "safety_plan" RENAME COLUMN "pro-resources" TO "professional_resources";--> statement-breakpoint
ALTER TABLE "safety_plan" RENAME COLUMN "safe-contacts" TO "safe_contacts";--> statement-breakpoint
ALTER TABLE "account" DROP CONSTRAINT "account_userId_user_id_fk";
--> statement-breakpoint
ALTER TABLE "session" DROP CONSTRAINT "session_userId_user_id_fk";
--> statement-breakpoint
ALTER TABLE "safety_plan" DROP CONSTRAINT "safety-plan_user_id_user_id_fk";
--> statement-breakpoint
