...
public static class DbInitializer
{
    ...
    private static async Task SeedQuestionBankAsync(ApplicationDbContext context)
    {
        ...
        var questions = new List<QuestionBank>
        {
            ...
            new()
            {
                Question = "What is a small goal you're working toward right now?",
                Category = "Growth",
            },
            new()
            {
            ...
            new()
            {
                Question = "If you could learn any new skill instantly, what would it be?",
                Category = "Fun",
            },
            new()
            {
                Question = "What is a book, movie, or song that has had a big impact on you?",
                Category = "Inspiration",
            },
            new()
            {
                Question = "How do you handle stress when things get overwhelming?",
                Category = "Coping",
            },
            new()
            {
                Question = "What does a perfect day look like to you?",
            ...
            new()
            {
                Question = "Who is someone that inspires you, and why?",
