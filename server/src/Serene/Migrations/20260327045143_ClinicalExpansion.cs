...
namespace Serene.Migrations
{
    ...
    public partial class ClinicalExpansion : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    shared_interest = table.Column<string>(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    completed_at = table.Column<Instant>(
                        type: "timestamp with time zone",
                        nullable: true
                    ),
        ...
        {
            migrationBuilder.DropTable(name: "peer_matches");

            migrationBuilder.DropTable(name: "scheduled_activities");

            migrationBuilder.DropTable(name: "user_interests");
