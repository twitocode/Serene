...
public static class RouteHandlerBuilderValidationExtensions
{
    ...
    ///     id returned by <paramref name="idSelector" />.
    /// </summary>
    /// <typeparam name="TEntity"></typeparam>
    /// <typeparam name="TRequest"></typeparam>
    /// <param name="builder"></param>
    /// <param name="idSelector">
    ///     A function which selects the <c>Id</c> property from the <typeparamref name="TRequest" />
    /// </param>
    /// <returns>A <see cref="RouteHandlerBuilder" /> that can be used to futher customize the endpoint.</returns>
    ...
    /// <summary>
    ///     Adds a request validation filter to the route handler to ensure the current <seealso cref="ClaimsPrincipal" /> owns
    ///     the <typeparamref name="TEntity" /> with the id returned by <paramref name="idSelector" />.
    /// </summary>
    /// <typeparam name="TEntity"></typeparam>
    /// <typeparam name="TRequest"></typeparam>
    /// <param name="builder"></param>
    ...
    /// </param>
    /// <returns>A <see cref="RouteHandlerBuilder" /> that can be used to futher customize the endpoint.</returns>
    public static RouteHandlerBuilder WithEnsureUserOwnsEntity<TEntity, TRequest>(this RouteHandlerBuilder builder,
        Func<TRequest, Guid> idSelector) where TEntity : class, IEntity, IOwnedEntity
    {
        return builder
            .AddEndpointFilterFactory((endpointFilterFactoryContext, next) => async context =>
            {
